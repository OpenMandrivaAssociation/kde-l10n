...
%define langlist ar bg bs ca cs da de el en_GB es et eu fi fr ga gl he hr hu ia id is it ja kk km kn ko lt lv nb nds nl nn pa pl ro ru sk sl sv th tr uk ug wa zh_CN zh_TW

%define disabled_langs af az be bn_IN bo br csb cy eo fa fo fy hne ku gu hi lo mai mi mk ml mt mr ne pt pt_BR se oc si sr ta tg ven vi xh
